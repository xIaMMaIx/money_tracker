...
TRANSLATIONS = {
    "en": {
        ...
        "day": "Day", "top_chart": "Top 10 Chart", "push_cloud": "Push to Google Sheets",
    ...
    "th": {
        ...
        "day": "วันที่", "top_chart": "10 อันดับสูงสุด", "push_cloud": "ส่งข้อมูลไป Google Sheets",
        ...
        "cloud_config": "ตั้งค่าการเชื่อมต่อ (Google Sheets)", "json_key": "ไฟล์กุญแจ (JSON Key)", "sheet_name": "ชื่อ Google Sheet",
